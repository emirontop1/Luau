...
function Aurora:CreateWindow(options)
    ...
    local window = setmetatable({ Gui = gui, Root = root, Nav = nav, Pages = pages, Tabs = {}, CurrentTab = nil, Theme = cloneTheme(Aurora.Themes[options.Theme or "Aurora"] or Aurora.Theme) }, Aurora)
